...
+ (NSString *)formatWithLunar:(Lunar *)lunar{
   ...
   NSArray *chineseMonths=[NSArray arrayWithObjects:
                               ...
                               @"九月", @"十月", @"冬月", @"腊月",@"腊月",@"腊月",@"腊月", nil];
       NSArray *chineseDays=[NSArray arrayWithObjects:
                             @"初一", @"初二", @"初三", @"初四", @"初五", @"初六", @"初七", @"初八", @"初九", @"初十",
                             @"十一", @"十二", @"十三", @"十四", @"十五", @"十六", @"十七", @"十八", @"十九", @"二十",
                             @"廿一", @"廿二", @"廿三", @"廿四", @"廿五", @"廿六", @"廿七", @"廿八", @"廿九", @"三十",@"三十",@"三十",@"三十",@"三十",@"三十",@"三十",  nil];
       //结果返回
        if (lunar.lunarMonth < 1 || lunar.lunarDay < 1){
            return [NSString stringWithFormat:@"%i-%@-%@",lunar.lunarYear,chineseMonths[0],chineseDays[0]];
        }
    
        if (lunar.lunarMonth <= chineseMonths.count && lunar.lunarDay <= chineseDays.count){
            return [NSString stringWithFormat:@"%i-%@-%@",lunar.lunarYear,chineseMonths[lunar.lunarMonth - 1],chineseDays[lunar.lunarDay - 1]];
                  
        }
    
    return [NSString stringWithFormat:@"%i-%@-%@",lunar.lunarYear,chineseMonths.lastObject,chineseDays.lastObject];
}
@end
