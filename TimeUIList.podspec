...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/335074307@qq.com/TimeUIList'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '335074307@qq.com' => '872447993@qq.com' }
  s.source           = { :git => 'https://github.com/335074307@qq.com/TimeUIList.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'TimeUIList' => ['TimeUIList/Assets/*.png']
  # }
